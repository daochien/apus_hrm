...
class BaseRepository
{
    ...
    {
        $schema = request()->user->schema; // lay schema tuong ung vs user
        $tableName = $this->model->getTable();
        $this->model->setTable($schema.'.'.$tableName);
    }
    ...
    {
        $this->applyConditions($where);
        $result = $this->model->withTrashed()->select($columns)->get();
        $this->resetModel();
        return $result;
    }
    ...
    public function updateOrCreate(array $where, array $update)
    {
        return $this->model
